...
print("Done tokenizing and padding.")
...
del wv_from_bin, word_index, embeddings_index, all_embs, embedding_matrix, model, inp, x
...
# pred_val_y = 0.25 * pred_google_val_y + 0.25 * pred_glove_val_y + 0.25 * pred_fasttext_val_y + 0.25 * pred_paragram_val_y
...
print("Best Thresh: " + str(best_thresh))

# pred_test_y = 0.25 * pred_google_test_y + 0.25 * pred_glove_test_y + 0.25 * pred_fasttext_test_y + 0.25 * pred_paragram_test_y
pred_test_y = 0.33 * pred_glove_test_y + 0.33 * pred_fasttext_test_y + 0.34 * pred_paragram_test_y
thres = best_thresh
pred_test_y = (pred_test_y>thres).astype(int)
